...
export function Footer() {
  return (
    <footer className="mt-12 border-t-2 border-[hsl(var(--panel-edge))]">
      <div className="container mx-auto px-6 py-8">
        {/* Header with BETA Badge */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-2">
            <img src="/logo.svg" alt="AscendOSRS" className="h-8 w-8" />
            <span className="text-2xl osrs-title" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
              AscendOSRS
            </span>
            <Badge className="osrs-badge text-xs">
              BETA
            </Badge>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="osrs-card p-6 text-center">
            <Coffee className="h-8 w-8 text-[hsl(var(--gold))] mx-auto mb-3" />
          ...
          <Card className="osrs-card p-6 text-center">
            <Crown className="h-8 w-8 text-[hsl(var(--gold))] mx-auto mb-3" />
            <h3 className="osrs-title text-lg mb-3">Beta Program</h3>
            <p className="osrs-muted text-sm mb-4">
