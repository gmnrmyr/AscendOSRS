  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col">
      ...
      <header className="w-full py-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-amber-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-2xl font-bold text-gray-900 dark:text-gray-100" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
                AscendOSRS
              </span>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="container mx-auto text-center">
          <div className="mb-6 sm:mb-8">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-4 px-2" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
          ...
          <div className="bg-white/60 dark:bg-gray-800/60 rounded-lg p-8 mb-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
      ...
      <section className="py-16 px-6 bg-white/50 dark:bg-gray-800/30">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-amber-600 to-yellow-600 dark:from-amber-700 dark:to-yellow-700">
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl font-bold text-white mb-4" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
              Ready to Ascend?
            </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold" style={{ fontFamily: 'RuneScape Bold, monospace' }}>
                AscendOSRS
              </span>
